...
public class FindGroupsUsersCommand : IFindGroupsUsersCommand
{
  public Task<OperationResultResponse<FindGroupsUsersResponse>> ExecuteAsync(FindGroupsUsersRequest request)
  {
